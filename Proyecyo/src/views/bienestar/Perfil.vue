<template>
  <div>
    <section class="page-heading">
      <div>
        <h2>Mi perfil</h2>
        <p>Actualiza tus datos personales y contraseña de acceso.</p>
      </div>
    </section>
            ...
            <form @submit.prevent="cambiarContrasena" novalidate>
              <div class="frm-grid">
                <div class="frm-field full" :class="{ 'is-invalid': errors.actual }">
                  ...
                  <div class="pass-wrap">
                    <input :type="showPassActual ? 'text' : 'password'" id="i-actual" v-model="formPass.actual">
                    <button type="button" class="pass-toggle" @click="showPassActual = !showPassActual">
                ...
                <div class="frm-field" :class="{ 'is-invalid': errors.nueva }">
                  ...
                  <div class="pass-wrap">
                    <input :type="showPassNueva ? 'text' : 'password'" id="i-nueva" v-model="formPass.nueva">
                    <button type="button" class="pass-toggle" @click="showPassNueva = !showPassNueva">
                ...
                <div class="frm-field" :class="{ 'is-invalid': errors.confirmar }">
                  ...
                  <div class="pass-wrap">
                    <input :type="showPassConf ? 'text' : 'password'" id="i-conf" v-model="formPass.confirmar">
                    <button type="button" class="pass-toggle" @click="showPassConf = !showPassConf">
...
function cargarPerfil() {
  ...
  if (sesion) {
    ...
    if (current) {
      ...
      statApoyos.value = obtenerApoyos().filter(a => a.creadoPor === ROLES.BIENESTAR).length;
    }
  }
}
